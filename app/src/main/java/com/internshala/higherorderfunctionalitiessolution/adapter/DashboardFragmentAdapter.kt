...
import com.internshala.higherorderfunctionalitiessolution.activity.RestaurantMenuActivity
...
import com.internshala.higherorderfunctionalitiessolution.model.Restaurant
...
class DashboardFragmentAdapter(val context: Context, var itemList: ArrayList<Restaurant>) :
    ...
    class ViewHolderDashboard(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val txtFavorite: ImageView = view.findViewById(R.id.txtFavorite)
    ...
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        Picasso.get().load(restaurant.restaurantImage).error(R.drawable.ic_action_restaurant_image)
        ...
        holder.txtFavorite.setOnClickListener {
            if (!DBAsyncTask(context, restaurantEntity, 1).execute().get()) {
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_action_fav_checked)
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_action_fav)
